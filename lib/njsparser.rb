...
module Njsparser
  ...
  # Raised when there is an error parsing Next.js data or HTML.
  class ParseError < Error; end
  
  # Raised when there is an error specifically related to Flight Data.
  class FlightDataError < Error; end
  
  # Raised when a required dependency (like execjs) is missing.
  class MissingDependencyError < Error; end

  # Creates a {Tools::FlightDataExplorer} instance from the given value.
  #
  ...
  # @return [Tools::FlightDataExplorer] A FlightDataExplorer instance for querying flight data.
  # @raise [TypeError] If the value type is unsupported.
  #
  # @example
  #   html = File.read('page.html')
  #   fde = Njsparser.flight_data_explorer(html)
  #   fde.find_all(class_filters: [Njsparser::T::RSCPayload])
  def self.flight_data_explorer(value)
    Tools::FlightDataExplorer.new(value)
  end
  ...
  #
  # @param obj [Tools::FlightDataExplorer, Parser::Types::Element]
