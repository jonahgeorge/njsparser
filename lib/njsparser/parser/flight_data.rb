      ...
      def self.decode_raw_flight_data(raw_flight_data)
        ...
        raw_flight_data.each do |seg|
          ...
          when Segment::IS_NOT_BOOTSTRAP
            raise FlightDataError, "initial_server_data_buffer not initialized" if initial_server_data_buffer.nil?
          ...
          when Segment::IS_BINARY
            ...
            raise FlightDataError, "Unknown segment type seg[0]=#{seg[0]}"
          end
        end
