...
module Njsparser
  ...
  module Tools
    ...
    #
    # FlightDataExplorer provides a BeautifulSoup-like API for working with flight data,
    # allowing you to search, filter, and iterate over elements in the flight data structure.
    #
    # @example Basic usage
    #   html = File.read('page.html')
    #   fde = Njsparser::Tools::FlightDataExplorer.new(html)
    #   rsc_payload = fde.find(class_filters: [Njsparser::T::RSCPayload])
    ...
    class FlightDataExplorer
      ...
      # Creates a new FlightDataExplorer instance from the given value.
      #
      ...
      #   fde = Njsparser::Tools::FlightDataExplorer.new(flight_data_hash)
      ...
      # Returns a string representation of the FlightDataExplorer instance.
      #
      # @return [String] A string showing the number of elements.
      def to_s
        "FlightDataExplorer(<#{length} elements>)"
      end
      ...
      # Creates a FlightDataExplorer instance from a list of elements.
      #
      ...
      # @return [FlightDataExplorer] A new FlightDataExplorer instance.
      # @raise [ArgumentError] If elements don't have indices and via_enumerate is not true.
      #
      # @example
      #   elements = [element1, element2, element3]
      #   fde = Njsparser::Tools::FlightDataExplorer.from_list(elements, via_enumerate: true)
    ...
    # Converts a FlightDataExplorer or Element instance to a hash.
    #
    # @param obj [FlightDataExplorer, Parser::Types::Element] The object to convert.
    # @return [Hash] A hash representation of the object.
    # @raise [TypeError] If the object type is unsupported.
    #
    # @example
    #   fde = Njsparser::Tools::FlightDataExplorer.new(html)
    #   hash = Njsparser::Tools.default(fde)
    def self.default(obj)
      case obj
      when FlightDataExplorer
