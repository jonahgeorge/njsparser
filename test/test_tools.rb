...
class TestTools < Minitest::Test
  ...
  def test_beautiful_fd
    assert_raises(TypeError) do
      Njsparser::Tools::BeautifulFD.new(nil)
    end

    fd = Njsparser::Tools::BeautifulFD.new(CLUB_FANS_HTML)
    assert fd.find
    ...
    assert Njsparser::Tools::BeautifulFD.new({})
    assert_equal 1, Njsparser::Tools::BeautifulFD.new({
    ...
    empty_bfd = Njsparser::Tools::BeautifulFD.new("<html></html>")
